...
class AuthFragment : Fragment() {
    ...
    private fun setupUI() {
        ...
        binding.verifyPhoneButton.setOnClickListener {
            ...
            if (validatePhoneNumber(phoneNumber)) {
                ...
                viewModel.onEvent(AuthEvent.VerifyPhoneNumber(phoneNumber, requireActivity()))
            }
        }
        ...
        binding.resendCodeButton.setOnClickListener {
            viewModel.onEvent(AuthEvent.ResendVerificationCode(requireActivity()))
        }
    }
    ...
    private fun updateUI(state: AuthState) {
        ...
        if (state.isPhoneAuthMode) {
            ...
            binding.toggleAuthModeButton.visibility = View.GONE
            ...
            binding.toggleAuthModeButton.visibility = View.VISIBLE
